...
> **Lecture #:** 1
> **Instructor:** 
> **Recording:** [Link](https://www.youtube.com/watch?v=gLULdxrS-CU&t=68s)

---

## Overview

Introduction to DCF (Discounted Cash Flow) valuation covering Net Present Value, Enterprise DCF Model, Free Cash Flows, WACC, Terminal Value, and equity valuation.
...
Because of this, you need to add a mid-year-adjustment, which we can do by incrementing by 0.5 instead of 1 when calculating the DCF.
...
1) Given to us, NPV = 113,395
   - With the mid-year adjustment factor, we get $113,395 \times 1.039 = 117,840$
...
Worked example: [Google Sheets](https://docs.google.com/spreadsheets/d/1eg0VmfDDadB6gbLi4duTIcwM-b7KBUJKCnnljwrc1KE/edit?gid=0#gid=0)
...
Worked example: [Google Sheets](https://docs.google.com/spreadsheets/d/1eg0VmfDDadB6gbLi4duTIcwM-b7KBUJKCnnljwrc1KE/edit?gid=908451720#gid=908451720)
...
- $g$ = Growth rate (based on the GDP of the country or industry standard rate)
...
Worked example: [Google Sheets](https://docs.google.com/spreadsheets/d/1eg0VmfDDadB6gbLi4duTIcwM-b7KBUJKCnnljwrc1KE/edit?gid=40010518#gid=40010518)
...
Worked example: [Google Sheets](https://docs.google.com/spreadsheets/d/1eg0VmfDDadB6gbLi4duTIcwM-b7KBUJKCnnljwrc1KE/edit?gid=1947024637#gid=1947024637)
...
Worked example: [Google Sheets](https://docs.google.com/spreadsheets/d/1eg0VmfDDadB6gbLi4duTIcwM-b7KBUJKCnnljwrc1KE/edit?gid=528535070#gid=528535070)
...
### Discounted Cash Flow Steps (YouTube Analysis)

1. **Forecast the Free Cash Flows (FCF)**
...
4. **Discount the FCF and Terminal Value**
...
### Free Cash Flows (YouTube Analysis)
...
> [!example] Enterprise DCF Model
> A comprehensive valuation approach that calculates enterprise value by discounting free cash flows and terminal value, then derives equity value by subtracting non-equity claims.

> [!example] Mid-Year Adjustment
> Adjusting DCF calculations to account for cash flows occurring throughout the year rather than only at year-end, using 0.5 instead of 1 in the discount factor.
...
| Term | Definition |
|------|------------|
| NPV | Net Present Value - discounted value for stream of cash flows |
| Enterprise DCF | Valuation method that values the entire enterprise, then derives equity value |
| Free Cash Flow | NOPLAT + non-cash items - Investments in Invested Capital |
| NOPLAT | Net Operating Profit Less Adjusted Taxes |
| WACC | Weighted Average Cost of Capital - cost of financing for a company |
| CAPM | Capital Asset Pricing Model - $E(R_i) = R_f + \beta_i(E(R_m) - R_f)$ |
| Terminal Value | Value of the business after the forecasted period |
| Enterprise Value | Value of operations + non-operating assets |
...
- [ ] Review YouTube video: [DCF Tutorial](https://www.youtube.com/watch?v=gLULdxrS-CU&t=68s)
- [ ] Practice DCF calculations using worked examples
...
- [[200 Finance/Corporate Valuation/Lectures/Week 01 - Lecture 1|Week 01 - Lecture 1]]

---

## References

- YouTube Video: [DCF Tutorial](https://www.youtube.com/watch?v=gLULdxrS-CU&t=68s)
- Worked Examples: [Google Sheets](https://docs.google.com/spreadsheets/d/1eg0VmfDDadB6gbLi4duTIcwM-b7KBUJKCnnljwrc1KE/edit)
