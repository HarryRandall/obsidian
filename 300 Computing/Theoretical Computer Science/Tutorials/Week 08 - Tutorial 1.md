...
Practice with structural induction over general inductive data types, termination proofs for functional programs, and negation normal form translation. Includes exercises on propositional formulae, Euclidean algorithm, and formula transformations.
...
### 3. Exercise 1: Propositional Formulae
...
### 4. Exercise 2: Euclidean Algorithm
...
### 5. Exercise 3: Negation Normal Form (MA, 3+7 credits)
...
> [!example] Termination Measure
> For recursive functions, you need to provide a `decreases` clause that shows the function terminates.
...
| Euclidean Algorithm | Algorithm for computing greatest common divisor |
| Negation Normal Form | Form where all negations are pushed to variables |
| De Morgan's Laws | Rules for distributing negation over conjunction/disjunction |
...
- [ ] How does negation normal form transformation work?

---

## Action Items

- [ ] Complete Exercise 1: Propositional Formulae
- [ ] Complete Exercise 2: Euclidean Algorithm
- [ ] Complete Exercise 3: Negation Normal Form (MA)
