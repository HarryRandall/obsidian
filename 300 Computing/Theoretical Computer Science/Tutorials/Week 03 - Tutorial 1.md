...
Practice with first-order logic interpretation, formalization in Dafny, proofs with quantifiers, and Knights and Knaves puzzles with treasure. Covers free and bound variables, quantifiers over integers, and logical reasoning.

---

## Key Concepts

### 1. Exercise 1: Interpretation of First Order Logic
...
### 5. Exercise 4: Knights and Knaves with Treasure (MA, 5+5 credits)
...
> [!example] Free vs Bound Variables
> - In $\exists y. E(y) \land D(x, y)$, $y$ is bound and $x$ is free
> - In $\forall x. \exists y. D(x, y)$, both $x$ and $y$ are bound

> [!example] Formalization in Dafny
> ```c
> ghost predicate E(x: int) { exists k: int :: x == 2 * k }
> ghost predicate D(x: int, y: int) { exists k: int :: x == y * k }
> ```
...
| Ghost Predicate | A predicate used for specification, not execution |
| Biconditional (<==>) | Logical equivalence: $(A \Rightarrow B) \land (B \Rightarrow A)$ |

---

## Questions & Discussion

- [ ] How do you identify free vs bound variables?
- [ ] What is the difference between $\forall \exists$ and $\exists \forall$?
- [ ] How do you model Knights and Knaves puzzles in Dafny?

---

## Action Items

- [ ] Complete Exercise 1: Interpretation of First Order Logic
- [ ] Complete Exercise 2: Formalisation
- [ ] Complete Exercise 3: Proof in Dafny
- [ ] Complete Exercise 4: Knights and Knaves with Treasure (MA)
