...
Introduction to requirements engineering covering self-organising teams, requirements definition, functional vs non-functional requirements, quality requirements, interviews, prototypes/mockups/stories, and conflict resolution and risk management.
...
> [!example] Quality Requirements Transformation
> **Informal Goal:** "System should be easy to use"
> **Verifiable Requirement:** "Experienced users shall make no more than two errors daily after two hours of training"

> [!example] Requirements Conflict Types
> - **Terminology Clash:** "borrower" vs. "patron" (different terms, same concept)
> - **Designation Clash:** "user" (library user vs. software user - same term, different concepts)
> - **Structure Clash:** Different structural representation of the same concept
...
| Requirements | Define what a system will do, not how it will do it |
| Functional Requirements | Describe what the system does, focusing on inputs, outputs, and responses without specifying how it achieves them |
| Nonfunctional Requirements | Define the quality which the system should perform, such as usability, performance, and security |
| Domain Knowledge | Bridges the environment (real-word context) and the machine (system functionality) |
| Requirements Engineering | Involves acquiring complete, consistent knowledge and representing it effectively for various stakeholders |
| Traceability | Maintains connections between requirements, showing dependencies and justifications |
| Configuration Management | Manages changes in a software system to facilitate integration and ensure controlled access for all developers |
...
- [ ] What are the key challenges in requirements gathering?
...
- [ ] How can prototypes and mockups help clarify requirements?
- [ ] What are the different types of conflicts in requirements and how can they be resolved?
...
- [ ] Practice creating verifiable quality requirements
- [ ] Review requirements conflict resolution strategies
